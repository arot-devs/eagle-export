...
@click.option("--hf-private", is_flag=True,
              help="If exporting to Hugging Face, make the dataset private.")
def main(eagle_dir, s5cmd, dest, hf_private):
    """
    ...
    Examples:
      ...
      eagle-export /path/to/library --to myuser/mydataset --hf-private
    """
    ...
    if dest.lower().endswith(".parquet"):
        ...
        export_huggingface(df, dest, private=hf_private)
